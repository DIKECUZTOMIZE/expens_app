...
class _SecondpageState extends State<Secondpage> {
  ...
  DateTime selstedDate = DateTime.now();
            ...
            children: [
              ...
              Container(
                  ...
                  child: InkWell(
                      ...
                      selstedDate= await   showCupertinoModalPopup(
                            context: context,
                            builder: (context) {
                              return Container(
                                height: 200,
                          ...
                          selstedDate = await showDatePicker(context: context,
              ...
              ElevatedButton(
                  onPressed: () async {
                    if (titleController.text.isNotEmpty &&
                        ...
                        selectedCatIndex > -1 && selstedDate.toString().isNotEmpty) {
                      //  DbHelper dbHelper = DbHelper.getInstance();

                      var prefs = await SharedPreferences.getInstance();
                      String uid = prefs.getString('userId') ?? '';

                      context.read<ExpensBloc>().add(AddExpens(
                          mdataE: ExpenssModels(
                              ...
                              category_id:
                                  AppConstant.mCat[selectedCatIndex].idCat,
                              balance: 0,
                              created_at: selstedDate.millisecondsSinceEpoch.toString())));
